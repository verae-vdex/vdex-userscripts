...
scriptCode.push('// Used to find all sprite types in PC');
scriptCode.push('var spriteArr = ["BW", "HGSS", "HGSS2", "PT", "PT2", "DP", "DP2", "FRLG", "RS", "EMERALD", "GOLD", "CRYSTAL", "SILVER", "Y", "RB", "G"];');
...
scriptCode.push('                if (pokemondata[pokemonID].length > 5) {');
scriptCode.push('                	var pokesprite = pokemondata[pokemonID][16].split("=")[2].split("poke/")[1].split("/")[0].toUpperCase();');
scriptCode.push('                	if (spriteArr.indexOf(pokesprite) == -1) {');
scriptCode.push('                		spriteArr.push(pokesprite.toUpperCase());');
scriptCode.push('                	}');
scriptCode.push('             	}');
scriptCode.push('            }');
scriptCode.push('        }');
...
scriptCode.push('    var createAdvForm = $("<div></div>").attr({');
scriptCode.push('        id: "advFindForm"');
scriptCode.push('    });');
scriptCode.push('    createAdvForm.append(\'<label>Gen:</label><select id="selGeneration" class="findselect"><option value="">Select</option><option value="1">Gen 1</option><option value="2">Gen 2</option><option value="3">Gen 3</option><option value="4">Gen 4</option><option value="5">Gen 5</option><option value="event">Event</option></select><br><label>Sprite:</label><select id="selSprite" class="findselect"><option value="">Select</option></select><br><input id="advFindPoke" type="button" class="btn" value="Find">\');');
scriptCode.push('    $("body").prepend(createAdvForm);');
scriptCode.push('    var createoverlay = $("<div></div>").attr({');
scriptCode.push('        id: "overlay"');
scriptCode.push('    });');
scriptCode.push('    $("body").prepend(createoverlay);');
...
scriptCode.push('        class: "infodivtab"');
scriptCode.push('    });');
scriptCode.push('    finddivtab.append(\'<label>ID:</label><input id="findID" type="text" class="findinput"><br><label>Name:</label><input id="findName" type="text" class="findinput"><br><label>Nature:</label><input id="findNature" type="text" class="findinput"><br><input id="advPoke" type="button" value="More" class="btn"><input id="findPoke" type="button" class="btn" value="Find"><p id="findresult"></p><br><div id="unseldiv" hidden="true">[ <span id="unselectfind" class="hlclickable">unselect</span> ]</div>\');');
...
scriptCode.push('    $("#advFindPoke").click(findpoke);');
scriptCode.push('    document.getElementById("unselectfind").addEventListener("click", unselectfoundpoke, false);');
scriptCode.push('');
scriptCode.push('    // Create the sprite dropdown menu');
scriptCode.push('    var dropelm;');
scriptCode.push('    for (i = 0; i < spriteArr.length; i++) {');
scriptCode.push('        dropelm = $("<option></option>").attr({');
scriptCode.push('            value: spriteArr[i].toLowerCase()');
scriptCode.push('        });');
scriptCode.push('        dropelm.append(spriteArr[i]);');
scriptCode.push('        $("#selSprite").append(dropelm);');
scriptCode.push('    }');
scriptCode.push('');
scriptCode.push('    // Add overlay behaviour');
scriptCode.push('    $("#advPoke").click(function () {');
scriptCode.push('        $("#advFindForm").fadeIn(500);');
scriptCode.push('        $("#overlay").fadeIn(500);');
scriptCode.push('    });');
scriptCode.push('    $("#overlay").click(function () {');
scriptCode.push('        $("#advFindForm").fadeOut(500);');
scriptCode.push('        $("#overlay").fadeOut(500);');
scriptCode.push('    });');
scriptCode.push('    $("#advFindPoke").click(function () {');
scriptCode.push('        $("#advFindForm").fadeOut(500);');
scriptCode.push('        $("#overlay").fadeOut(500);');
scriptCode.push('    });');
scriptCode.push('');
...
scriptCode.push('    var pokemonNature = document.getElementById("findNature").value.replace(/,/g, "&#44;").toLowerCase();');
scriptCode.push('    var e = document.getElementById("selGeneration");');
scriptCode.push('    var pokemonGen = e.options[e.selectedIndex].value;');
scriptCode.push('    e = document.getElementById("selSprite");');
scriptCode.push('    var pokemonSprite = e.options[e.selectedIndex].value;');
scriptCode.push('    var gentable = {1:["rb", "y", "g"], 2: ["gold", "silver", "crystal"], 3: ["emerald", "rs", "frlg"], 4: ["hgss", "hgss2", "pt", "pt2", "dp", "dp2"], 5: ["bw"], all: ["rb", "y", "g", "gold", "silver", "crystal", "emerald", "rs", "frlg", "hgss", "hgss2", "pt", "pt2", "dp", "dp2", "bw"]};');
scriptCode.push('');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u00E9/g, "&eacute;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u273F/g, "&#10047;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\uFF3C/g, "&#65340;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\uFF61/g, "&#65377;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u25E1/g, "&#9697;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u25C9/g, "&#9673;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u203F/g, "&#8255;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u25D5/g, "&#9685");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u30CE/g, "&#12494;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2299/g, "&#8857;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u25E0/g, "&#9696;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2267/g, "&#8807;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2266/g, "&#8806;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u0CA0/g, "&#3232;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\uFF40/g, "&#65344;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2579/g, "&#9593;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2606/g, "&#9734;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\uFF0F/g, "&#65295;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u4EBA/g, "&#20154;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2310/g, "&#8976;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u25A0/g, "&#9632;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u256F/g, "&#9583;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u25A1/g, "&#9633;");');
...
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u253B/g, "&#9531;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2501/g, "&#9473;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u76CA/g, "&#30410;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u5F61/g, "&#24417;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u252C/g, "&#9516;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u2500/g, "&#9472;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u309C/g, "&#12444;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u10DA/g, "&#4314;");');
scriptCode.push('    pokemonNature = pokemonNature.replace(/\u0298/g, "&#664;");');
scriptCode.push('');
...
scriptCode.push('                foundSlots.push(pokedict[key][pokedict[key].length - 1]);');
scriptCode.push('            } else {');
scriptCode.push('                var pokeNature = pokemonNature.replace(/\\(/g, "&#40;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\u005F/g, "&#95;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\u002D/g, "&#45;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\\)/g, "&#41;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\u0074/g, "&#84;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\u2665/g, "&#9829;");');
//scriptCode.push('                pokeNature = pokeNature.replace(/\u002A/g, "&#42;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\u00B0/g, "&#176;");');
scriptCode.push('                pokeNature = pokeNature.replace(/\u00B4/g, "&#180;");');
scriptCode.push('                if (pokeNature == foundNature) {');
scriptCode.push('                    foundSlots.push(pokedict[key][pokedict[key].length - 1]);');
scriptCode.push('                } else {');
scriptCode.push('                    var heartsFace = pokeNature.replace(/&#9829;/g, "&hearts;");');
scriptCode.push('                    if (heartsFace == foundNature) {');
scriptCode.push('                        foundSlots.push(pokedict[key][pokedict[key].length - 1]);');
scriptCode.push('                    }');
scriptCode.push('                }');
scriptCode.push('            }');
scriptCode.push('        } else if ((pokemonGen || pokemonSprite) && !!pokedict[key][16]) {');
scriptCode.push('            var pokesprite = pokemondata[key][16].split("=")[2].split("poke/")[1].split("/")[0];');
scriptCode.push('            if (pokemonSprite){');
scriptCode.push('                if(pokemonSprite == pokesprite){;');
scriptCode.push('                    foundSlots.push(pokedict[key][pokedict[key].length - 1]);');
scriptCode.push('             	 }');
scriptCode.push('            } else {');
scriptCode.push('                if(pokemonGen != "event"){;');
scriptCode.push('                    for (var j = 0; j < gentable[pokemonGen].length; j ++) {');
scriptCode.push('                        if(gentable[pokemonGen][j] == pokesprite){;');
scriptCode.push('                            foundSlots.push(pokedict[key][pokedict[key].length - 1]);');
scriptCode.push('             	         }');
scriptCode.push('                	 }');
scriptCode.push('             	 } else {');
scriptCode.push('             	     var found = false;');
scriptCode.push('                    for (var j = 0; j < gentable["all"].length; j ++) {');
scriptCode.push('                        if(gentable["all"][j] == pokesprite){;');
scriptCode.push('                            found = true;');
scriptCode.push('             	         }');
scriptCode.push('                	 }');
...
cssscript.push('}');
cssscript.push('#findPoke, #advFindPoke {');
cssscript.push('    float: right;');
cssscript.push('    display:block;');
cssscript.push('}');
cssscript.push('#advPoke {');
cssscript.push('    float: left;');
cssscript.push('}');
cssscript.push('#overlay, #advFindForm {');
cssscript.push('    display: none;');
cssscript.push('}');
cssscript.push('#overlay {');
cssscript.push('    position:fixed;');
cssscript.push('    width: 100%;');
cssscript.push('    height: 100%;');
cssscript.push('    top: 0px;');
cssscript.push('    left: 0px;');
cssscript.push('    background: black;');
cssscript.push('    opacity: 0.4;');
cssscript.push('    filter:alpha(Opacity=40);');
cssscript.push('    z-index: 500;');
cssscript.push('}');
cssscript.push('#advFindForm {');
cssscript.push('    position:fixed;');
cssscript.push('    top: 50%;');
cssscript.push('    left: 50%;');
cssscript.push('    margin-top: -65px;');
cssscript.push('    margin-left: -150px;');
cssscript.push('    width: 300px;');
cssscript.push('    height: 130px;');
cssscript.push('    background: white;');
cssscript.push('    padding: 5px;');
cssscript.push('    z-index: 999;');
cssscript.push('}');
cssscript.push('select {');
cssscript.push('    border: 1px solid #d9d9d9;');
cssscript.push('    color: #808080;');
cssscript.push('    padding: 3px 6px;');
cssscript.push('}');
cssscript.push('.findselect {');
cssscript.push('    display: inline-block;');
cssscript.push('    margin-top: 10px;');
cssscript.push('    margin-bottom: 10px;');
cssscript.push('    width: 214px;');
cssscript.push('}');
